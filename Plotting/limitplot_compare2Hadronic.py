...
#narrow
xcms, ycms = array( 'd',[0.70143	,0.72609	,0.7531	,0.78114	,0.82014	,0.87333	,0.92811	,0.9646	,1.02712	,1.06968	,1.14832	,1.24035	,1.33427	,1.43831	,1.55988	,1.69179	,1.80525	,1.96173	,2.09336	,2.30265	,2.56381	,2.913	,3.15881	,3.52398	,3.87567	,4.38516	,4.9412	,5.4896	,5.9643	]), array( 'd',[19.598	,16.492	,14.751	,12.54	,10.553	,9.2501	,7.8645	,6.8927	,6.2287	,5.4039	,4.6416	,3.6757	,3.0937	,2.4006	,1.9011	,1.4456	,1.1922	,0.98328	,0.78657	,0.62931	,0.49842	,0.38686	,0.34962	,0.29732	,0.28272	,0.25297	,0.24802	,0.23347	,0.23356	,]),
#broad
xcms_b, ycms_b = array( 'd',[0.70284	,0.73183	,0.75588	,0.78072	,0.82118	,0.8796	,0.93647	,1.01738	,1.10528	,1.20563	,1.30187	,1.452	,1.55529	,1.69994	,1.85803	,1.9902	,2.1753	,2.45575	,2.71689	,3.00579	,3.43472	,3.92485	,4.46683	,5.0836	,5.7159	,6	,]), array( 'd',[28.506	,23.716	,20.139	,18.183	,15.44	,13.246	,11.248	,9.0759	,7.707	,6.2186	,4.8661	,3.5449	,2.7178	,2.0837	,1.5813	,1.2629	,1.0087	,0.76547	,0.63039	,0.52448	,0.42318	,0.38208	,0.33455	,0.33455	,0.34146	,0.34851	]),

for i in range(len(xcms)):
    xcms[i] = xcms[i]*1000
for i in range(len(xcms_b)):
    xcms_b[i] = xcms_b[i]*1000
