...
varlistsys=[
    ...
    ("QCDScaleWeights",    None, "", (50,0.8,1.2)),
    ("QCDScaleWeights[0]", None, "", (50,0.8,1.2)),
    ("QCDScaleWeights[1]", None, "", (50,0.8,1.2)),
    ("QCDScaleWeights[2]", None, "", (50,0.8,1.2)),
    ("QCDScaleWeights[3]", None, "", (50,0.8,1.2)),
    ("QCDScaleWeights[4]", None, "", (50,0.8,1.2)),
    ("QCDScaleWeights[5]", None, "", (50,0.8,1.2)),
