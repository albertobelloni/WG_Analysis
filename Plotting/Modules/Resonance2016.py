def config_samples(samples) :
    ...
    samples.AddSample('ZGTo2LG',
                      ...
                      isActive=False, useXSFile=True )
    samples.AddSample('ZGTo2LGPhOlap',
                      path='ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8PhCutMin',
                      isActive=False, useXSFile=True, XSName='ZGTo2LG' )
    ...
    samples.AddSample('TTToSemiLeptonic',
                      path='TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8',
                      isActive=False, useXSFile=True )
    ...
    samples.AddSample('WGToLNuG-amcatnloFXFX',
                      path='WGToLNuG_01J_5f_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8',
    ...
    samples.AddSample('WGToLNuG-amcatnloFXFXPhCut',
                      path='WGToLNuG_01J_5f_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8PhCutMaxPhCutMin',
    ...
    samples.AddSample('WJetsToLNu-madgraphMLMPhOlap',
                      ...
                      isActive=False, useXSFile=True, XSName='WJetsToLNu-madgraphMLM' )
    ...
    samples.AddSample('WZG',
                      path='WZG_TuneCUETP8M1_13TeV-amcatnlo-pythia8',
                      isActive=False, useXSFile=True )
    ...
    samples.AddSample('MadGraphResonanceMass300_width5', path='MadGraphChargedResonance_WGToLNu_M300_width5', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kRed, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 300 GeV', XSName='ResonanceMass300') ## NOTE active
    ...
    samples.AddSample('MadGraphResonanceMass450_width5', path='MadGraphChargedResonance_WGToLNu_M450_width5', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kBlue, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 450 GeV', XSName='ResonanceMass450') # NOTE active
    samples.AddSample('MadGraphResonanceMass500_width0p01', path='MadGraphChargedResonance_WGToLNu_M500_width0p01', isActive=True, isSignal=True, useXSFile=True, plotColor=ROOT.kRed, legend_name = 'M-500 N', XSName='ResonanceMass500')
    samples.AddSample('MadGraphResonanceMass500_width5', path='MadGraphChargedResonance_WGToLNu_M500_width5', isActive=True, isSignal=True, useXSFile=True, plotColor=ROOT.kViolet, legend_name = 'M-500 W', XSName='ResonanceMass500')
    samples.AddSample('MadGraphResonanceMass600_width0p01', path='MadGraphChargedResonance_WGToLNu_M600_width0p01', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kGreen, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 600 GeV', XSName='ResonanceMass600') ## NOTE: ACTIVE SIGNAL
    ...
    samples.AddSample('MadGraphResonanceMass1000_width5', path='MadGraphChargedResonance_WGToLNu_M1000_width5', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kBlack, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 1000 GeV', XSName='ResonanceMass1000')
    ...
    samples.AddSample('MadGraphResonanceMass1400_width0p01', path='MadGraphChargedResonance_WGToLNu_M1400_width0p01', isActive=True, isSignal=True, useXSFile=True, plotColor=ROOT.kBlue, legend_name = 'M-1400 N', XSName='ResonanceMass1400')
    samples.AddSample('MadGraphResonanceMass1400_width5', path='MadGraphChargedResonance_WGToLNu_M1400_width5', isActive=True, isSignal=True, useXSFile=True, plotColor=ROOT.kGreen, legend_name = 'M-1400 W', XSName='ResonanceMass1400')
