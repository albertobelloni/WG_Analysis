def config_samples(samples) :
    ...
    samples.AddSample('MadGraphResonanceMass450_width5', path='MadGraphChargedResonance_WGToLNuG_M450_width5', isActive=True, isSignal=True, useXSFile=True, plotColor=ROOT.kBlue, legend_name = 'M(#Phi^{#pm}) = 450 GeV', XSName='ResonanceMass450') # NOTE active signal
    ...
    samples.AddSample('MadGraphResonanceMass600_width0p01', path='MadGraphChargedResonance_WGToLNuG_M600_width0p01', isActive=True, isSignal=True, useXSFile=True, plotColor=ROOT.kRed, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 600 GeV', XSName='ResonanceMass600') ##NOTE: Active Signal
