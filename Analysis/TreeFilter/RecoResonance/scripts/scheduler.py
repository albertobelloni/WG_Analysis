...
#output_base = '/eos/cms/store/group/phys_exotica/Wgamma/Resonances%i/' %options.year
jobtag = '_2019_05_29'
...
jobs2017 = [
        ...
        JobConf(base, 'TTJets_DiLept_TuneCP5_13TeV-madgraphMLM-pythia8', version=version2017, year=2017     ),
        JobConf(base, 'TTJets_SingleLeptFromTbar_TuneCP5_13TeV-madgraphMLM-pythia8', version=version2017, year=2017     ),
        JobConf(base, 'TTJets_SingleLeptFromT_TuneCP5_13TeV-madgraphMLM-pythia8' , version=version2017, year=2017    ),
        ...
        JobConf( base, 'DiPhotonJets_MGG-80toInf_13TeV_amcatnloFXFX_pythia8', version=version, tags=['NLO'], year=2017),
