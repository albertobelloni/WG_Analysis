...
configs = [
    ...
    #{
    #    'module' : 'Conf.py',
    #    'args'   : { 'function' : 'make_final_mug', 'mu_pt' : ' > 10 ', 'el_pt' : ' > 10 ' , 'ph_pt' : ' > 10 ', 'phot_vars' : 'True' },
    #    'args_tag_NLO' : args_nlo,
    #    'input'  : '',
    #    'output' : output_base+'LepGamma_mug_2019_04_11',
    #    'tag'    : 'mug',
    #    'dataset': 'SingleMuon',
    #},
    #{
    #    'module' : 'Conf.py',
    #    'args'   : { 'function' : 'make_final_elg', 'mu_pt' : ' > 10 ', 'el_pt' : ' > 10 ' , 'ph_pt' : ' > 10 ', 'eleVeto' : 'None', 'phot_vars' : 'True'},
    #    'args_tag_NLO' : args_nlo,
    #    'input'  : '' ,
    #    'output' : output_base+'LepGamma_elg_2019_04_11',
    #    'tag'    : 'elg',
    #    'dataset': 'SingleElectron',
    #},
    #{
